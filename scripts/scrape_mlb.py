...
def create_team_hitting():
    ...
    teams.to_csv("data/teamStatistics1995-2023.csv")
...
def create_team_pitching():
    ...
    team_pitching.to_csv("data/teamPitching1995-2023.csv")
